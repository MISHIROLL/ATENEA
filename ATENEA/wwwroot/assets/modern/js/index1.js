$(function(e) {
	...
	gradientStroke1.addColorStop(0, '#3701ff');
	gradientStroke1.addColorStop(1, '#510fa7');
	
	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 200);
	gradientStroke2.addColorStop(0, '#d47d13');
	gradientStroke2.addColorStop(1, '#ff9002');
	...
	var myCanvasContext = ctx.getContext("2d");
	var gradientStroke1 = myCanvasContext.createLinearGradient(0, 0, 0, 200);
	gradientStroke1.addColorStop(0, '#510fa7');
	gradientStroke1.addColorStop(1, '#3701ff');
	...
	var myCanvasContext = ctx.getContext("2d");
	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 200);
	gradientStroke2.addColorStop(0, '#ff9002');
	gradientStroke2.addColorStop(1, '#d47d13');
	...
	gradientStroke3.addColorStop(1, '#1e9fc4');
	ctx.height = 135;
    var myChart = new Chart( ctx, {
        type: 'bar',
        data: {
	...
	gradientStroke4.addColorStop(0, '#510fa7');
	gradientStroke4.addColorStop(1, '#3701ff');
	var myChart = new Chart(ctx, {
		type: 'line',
		data: {
