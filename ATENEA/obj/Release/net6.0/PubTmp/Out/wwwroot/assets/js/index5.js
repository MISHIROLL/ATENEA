	    ...
	    var myChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					...
					pointHighlightStroke: "rgba(21, 114, 232,0.5)",
    ...
    var myChart = new Chart( ctx, {
        ...
        data: {
            ...
            datasets: [ {
                ...
                label: 'Market value',
                backgroundColor: 'rgba(21, 114, 232, 0.9)',
                borderColor: 'rgba(21, 114, 232)',
				pointRadius: 0,
            }, ]
        },
        options: {
    ...
    var myChart = new Chart( ctx, {
        ...
        data: {
            ...
            datasets: [ {
                ...
                label: 'Market value',
                backgroundColor: 'rgba(255, 158, 39, 0.9)',
                borderColor: 'rgba(255, 158, 39)',
				pointRadius: 0,
            }, ]
        },
        options: {
